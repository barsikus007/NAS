...
# echo LDAP_BIND_READONLY="$LDAP_BIND_READONLY"
# sed "s/%%LDAP_BIND_READONLY%%/$LDAP_BIND_READONLY/g" -i $NEW_FILE
# echo LDAP_BIND_READONLY_PASSWORD="$LDAP_BIND_READONLY_PASSWORD"
# sed "s/%%LDAP_BIND_READONLY_PASSWORD%%/$LDAP_BIND_READONLY_PASSWORD/g" -i $NEW_FILE
echo
echo
